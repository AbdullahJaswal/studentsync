...
export default function Home() {
  ...
  const [cardsData, setCardsData] = useState([
    { title: "Looking for group members for Software testing assignment 2", description: "Looking for 3 group members for Software testing assignment 2", username: "Alice Johnson" },
    { title: "Project B", description: "A brief description of Project B.", username: "Bob Smith" },
    { title: "Project C", description: "A brief description of Project C.", username: "Charlie Brown" },
  ]);
  ...
  const handleSubmitPost = () => {
    const newPost = {
      ...
      username: "Rohan Mhadgut" // Replace with dynamic user data if available
    };
  ...
  return (
    <div className="flex container p-4 max-w-full mt-4">
      ...
      <div className="w-1/4 pr-4">
        <Card className="shadow-md rounded-lg">
          ...
          <CardContent className="mt-8 p-6">
            ...
            <Button variant="secondary" className="mt-4" onClick={() => setIsModalOpen(true)}>Find Teammate</Button>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="w-3/4 pl-4">
        <h2 className="text-lg font-semibold mb-4">See who is looking for a teammate</h2>
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent>
          ...
          <DialogFooter>
            <Button variant="secondary" onClick={handleSubmitPost}>Submit</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </div>
